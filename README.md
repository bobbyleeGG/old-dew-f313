...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/old-dew-f313
```

A live public deployment of this template is available at [https://old-dew-f313.templates.workers.dev](https://old-dew-f313.templates.workers.dev)
